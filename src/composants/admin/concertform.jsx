...
const ConcertForm = () => {
    ...
    useEffect(() => {
        const fetchConcertAndScenes = async () => {
            try {
                ...
                const concertResponse = await axios.get(`https://cornflowerblue-otter-463564.hostingersite.com/concert/${id}`);
                ...
                const scenesResponse = await axios.get("https://cornflowerblue-otter-463564.hostingersite.com/scenes");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`https://cornflowerblue-otter-463564.hostingersite.com/updateconcert`, {
