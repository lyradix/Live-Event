...
function Status(props) {
    ...
    const { pending, error, postData } = FetchData('https://cornflowerblue-otter-463564.hostingersite.com/login');
    ...
    const handleLogin = async () => {
        try {
            ...
            await postData('https://cornflowerblue-otter-463564.hostingersite.com/login', payload);
